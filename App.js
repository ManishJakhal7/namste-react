  ...
  return (
    <div className="head">
      <div className="logo-conainer">
        <img
          className="logo"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeahVBxW16kypJUTRFKvTPbEqqQ9WwY_Jbow&s"
        />
      </div>
...
const dataList = [
  ...
  },
  {
    info: {
      ...
      name: "Subway",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/4/8c270b25-fdb3-4b76-808e-4f2a7b133a6e_10392.JPG",
      locality: "Sector 3",
      areaName: "Rohini M2K",
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-08-19 05:00:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      ...
      name: "McDonald's",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/8/14/0338efe6-995d-4ae7-af8b-d34dd969eac9_253731.JPG",
      locality: "Sector 3",
      areaName: "Rohini",
      costForTwo: "₹400 for two",
      cuisines: ["American"],
      ...
      availability: {
        nextCloseTime: "2024-08-18 23:45:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      name: "KFC",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/17/69e69c55-d2bb-4207-8310-131fc693f78a_26723.JPG",
      locality: "Sector 3",
      areaName: "Rohini",
      costForTwo: "₹400 for two",
  ...
  },
  {
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/olio-the-wood-fired-pizzeria-khasra-no-22-nihankari-satsang-bhawan-delhi-785298",
      type: "WEBLINK",
    },
  },
  {
...
const Body = () => {
  return (
    <div className="body">
      ...
      <Restaurantcard resData={dataList[0]} />
